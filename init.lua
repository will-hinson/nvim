...
vim.keymap.set('i', '<C-M-left>', function() vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes("<esc>vB", true, false, true), "n", false) end, {})
...
vim.keymap.set('i', '<C-M-right>', function() vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes("<esc>vE", true, false, true), "n", false) end, {})
